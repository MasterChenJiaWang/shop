...
import com.chen.portal.service.ItemService;
...
public class ItemServiceImpl  implements ItemService{
	...
	public ItemInfo getItemById(Long itemId) {
		try {
			...
			if (!StringUtils.isBlank(json)) {
				ShopResult taotaoResult = ShopResult.formatToPojo(json, ItemInfo.class);
	...
	public String getItemDescById(Long itemId) {
		try {
			...
			//转换成java对象
			ShopResult taotaoResult = ShopResult.formatToPojo(json, TbItemDesc.class);
			if (taotaoResult.getStatus() == 200) {
	...
	public String getItemParam(Long itemId) {
		try {
			...
			//把json转换成java对象
			ShopResult taotaoResult = ShopResult.formatToPojo(json, TbItemParamItem.class);
			if (taotaoResult.getStatus() == 200) {
